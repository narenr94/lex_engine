...
const std::vector<SpacesConfig> spacesConfig = {
    {0, "Go", SpaceType::Special, SpaceColor::Brown, 0, 0, 0, {0}},
    {1, "Mediterranean Avenue", SpaceType::Property, SpaceColor::Brown, 60, 30, 50, {2, 10, 30, 90, 160, 250}},
    {2, "Community Chest", SpaceType::Special, SpaceColor::NA, 0, 0, 0, {0}},
    {3, "Baltic Avenue", SpaceType::Property, SpaceColor::Brown, 60, 30, 50, {4, 20, 60, 180, 320, 450}},
    {4, "Income Tax", SpaceType::Tax, SpaceColor::NA, 200, 0, 0, {0}},
    {5, "Reading Railroad", SpaceType::Railroad, SpaceColor::NA, 200, 100, 0,{25}},
    {6,"Oriental Avenue",SpaceType::Property ,SpaceColor::LightBlue ,100 ,50 ,50 ,{6 ,30 ,90 ,270 ,400 ,550}},
    {7,"Chance",SpaceType::Special ,SpaceColor::NA ,0 ,0 ,0 ,{0}},
    ...
    {10,"Jail/Just Visiting",SpaceType::Special, SpaceColor::NA, 0, 0, 0, {0}},
    {11,"St. Charles Place",SpaceType::Property, SpaceColor::Magenta, 140, 70, 100, {10, 50, 150, 450, 625, 750}},
    {12,"Electric Company",SpaceType::Utility, SpaceColor::NA, 150, 75, 0,{4}},
    ...
    {15,"Pennsylvania Railroad",SpaceType::Railroad, SpaceColor::NA,200 ,100 ,0,{25}},
    {16,"St. James Place",SpaceType::Property, SpaceColor::Orange,180 ,90 ,100,{14 ,70 ,200 ,550 ,750 ,950}},
    {17,"Community Chest",SpaceType::Special, SpaceColor::NA,0 ,0 ,0,{0}},
    ...
    {20,"Free Parking",SpaceType::Special, SpaceColor::NA, 0, 0, 0, {0}},
    {21,"Kentucky Avenue",SpaceType::Property, SpaceColor::Red,220 ,110 ,150,{18 ,90 ,250 ,700 ,875 ,1050}},
    {22,"Chance",SpaceType::Special, SpaceColor::NA, 0, 0, 0, {0}},
    ...
    {25,"B&O Railroad",SpaceType::Railroad, SpaceColor::NA,200 ,100 ,0,{25}},
    ...
    {28,"Water Works",SpaceType::Utility, SpaceColor::NA,150 ,75 ,0,{4}},
    {29,"Marvin Gardens",SpaceType::Property, SpaceColor::Yellow,280 ,140 ,150,{24 ,120 ,360 ,850 ,1025 ,1200}},
    {30,"Go To Jail",SpaceType::Special, SpaceColor::NA, 0, 0, 0,{0}},
    ...
    {33,"Community Chest",SpaceType::Special, SpaceColor::NA, 0, 0, 0,{0}},
    {34,"Pennsylvania Avenue",SpaceType::Property, SpaceColor::Green,320 ,160 ,200,{28 ,150 ,450 ,1000 ,1200 ,1400}},
    {35,"Short Line",SpaceType::Railroad, SpaceColor::NA,200 ,100 ,0,{25}},
    {36,"Chance",SpaceType::Special, SpaceColor::NA, 0, 0, 0,{0}},
    {37,"Park Place",SpaceType::Property, SpaceColor::DarkBlue,350 ,175 ,200,{35 ,175 ,500 ,1100 ,1300 ,1500}},
    {38,"Luxury Tax",SpaceType::Tax, SpaceColor::NA,100 ,0 ,0,{0}},
